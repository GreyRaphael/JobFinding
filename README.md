...
爬虫[新奥](https://enn.zhiye.com/campus), 发现216个岗位，0个合适岗位

## 2021年08月16日

查看[Amazon China](https://amazongcnstudents.splashthat.com/), 0个合适岗位

## 2021年08月18日

爬虫[快手](https://campus.kuaishou.cn/#/campus/jobs), 发现186个岗位，0个合适岗位

## 2021年08月26日

收到[小米](https://app.mokahr.com/campus_apply/xiaomi/286#/job/b0c8f8cf-8462-46ba-abfd-ca5054b04eae)未来星面试，8月31面试
> 未来星-风险策略分析师-天星数科  

岗位描述：
1. 研究金融风险相关领域行业动态，学习零售金融的风控模式，根据不同的业务场景设计风控流程，参与全流程风险策略体系的建设；
2. 应用各类用户数据，包括小米体系内数据、征信数据、第三方数据等，基于机器学习/统计学习方法，完善用户画像体系，开展特征挖掘，研发和应用风控和营销模型，制定决策规则和策略；
3. 通过团队协作，推进项目和策略的落地，并制定全面的策略监控、实验、优化、迭代的实施方案，确保风险策略的有效性和风控目标的达成。

任职要求：
1. 硕士以上学历，博士优先，数据科学、统计学、应用数学、物理、金融工程、计量经济等专业方向；
2. 具备扎实的数理基础，清晰的逻辑思维，出色的数据分析能力；
3. 编程能力良好，熟悉常用算法和数据结构，熟练掌握至少一门语言（C/C++/python/java/R/...）；
...
[小米](https://app.mokahr.com/campus_apply/xiaomi/286#/job/b0c8f8cf-8462-46ba-abfd-ca5054b04eae)未来星面试
...
2. 渠道A和渠道B, 通过率都下降了，整体的通过率提高，这个可能发生吗？举个例子

3. 两个囚徒1，2；两个箱子A, B分别放了1，2；有放回的拿；
如果1拿到1，2拿到2，那么两个人释放；如果有一个人拿错了，就处死
   - 3.1 两个人随机拿，被释放的概率多大
   - 3.2 采用什么策略，才能提高被释放的概率
   - 3.3(回去想想) 如果有100个囚徒；100个箱子；每次开50个箱子；有放回地拿；
每个人都能在50个箱子开出自己的号码，那么全部释放，应该采用什么策略提高被释放的概率

## 2021年09月06日

爬虫[度小满](https://campus.duxiaoman.com/campus_apply/duxiaoman/1482#/jobs), 发现0个合适岗位

尝试中核

https://scc.pku.edu.cn/employment_22e903457b9e05ea017b9f139fc5015d_0.html
...
[中国电子](https://cecjob.iguopin.com)爬虫137个岗位，0个合适岗位


中信证券算法题目1：
- '600006@24@1000@000001@26.3@2000@600006@25@1000'表示'股票代码@股价@成交量', 返回'股票代码@最低价@最高价@最新价@加权价格'
  - '600006@24.50@1000@000001@26.3@2000'

中信证券算法题目3: 根据行列生成矩阵，并求矩阵所有元素的和
- input: 4, 3
- 第一行(列), 1, 2, 3, 2, 1
- 其他元素： matrix[i][j]=matrix[i][j-1]+matrix[i-1][j]
- [1, 2, 1]
- [2, 4, 5]
- [2, 6, 11]
- [1, 7, 18]
...
爬虫[荣耀北京](https://career.hihonor.com/SU60eea1aa0dcad47a7e1ce1ed/pb/posDetail.html?postId=60efe0cbbef57c1023f7610f&postType=campus), 发现2个合适岗位(放弃投简历)
...
导控所:
- 晋升机制：3个月实习研究员→3个月助理研究员→2年副研究员→5年研究员
- 博士: 40w+
- 工作地点: 海淀区北坞创新园，4年后昌平未来城
- 户口: √
- 工作时间:一周6天，自觉加班
  - 周一~周五  8:30~17:30
  - 周六 9:00~17:00
...
- 2021年09月18日: 网络笔试
- 2021年10月11日: 线下面试
- 2021年10月18日: 线下面试通过通知
- 2021年10月21日: 网络面试
- 2021年11月04日: 上报蓝剑计划
- 2021年11月16日: 蓝剑计划通过副总裁批准，等待HR面试， 50w
